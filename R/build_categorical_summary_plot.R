...
#' caption are applied at the output stage; this function sets no labels. Panels stack vertically with `space = "free_y"` so panel
...
build_categorical_summary_plot <- function(dt,
  ...
  p <- ggplot2::ggplot(prop, ggplot2::aes(x = prop, y = .level,
    ...
    ggplot2::geom_errorbar(
      ...
      width = 0, linewidth = 0.3, colour = "grey25") +
